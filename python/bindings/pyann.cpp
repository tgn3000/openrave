...
object search(ANNkd_tree& kdtree, object q, int k, double eps, bool priority = false)
{
    ...
    return boost::python::make_tuple(static_cast<bpndarray>(handle<>(pyidx)), static_cast<bpndarray>(handle<>(pydists)));
}
...
object k_fixed_radius_search(ANNkd_tree& kdtree, object q, double sqRad, int k, double eps)
{
    ...
    if( k <= 0 ) {
        ...
        return boost::python::make_tuple(bpndarray(boost::python::list()).astype("i4"),bpndarray(boost::python::list()),kball);
    }
    ...
    return boost::python::make_tuple(static_cast<bpndarray>(handle<>(pyidx)), static_cast<bpndarray>(handle<>(pydists)),kball);
}
...
object k_fixed_radius_search_array(ANNkd_tree& kdtree, object qarray, double sqRad, int k, double eps)
{
    ...
    int N = len(qarray);
    if( N == 0 )
        return boost::python::make_tuple(bpndarray(boost::python::list()).astype("i4"),bpndarray(boost::python::list()),bpndarray(boost::python::list()));
    ...
    if( k <= 0 ) {
        ...
        return boost::python::make_tuple(bpndarray(boost::python::list()).astype("i4"),bpndarray(boost::python::list()),static_cast<bpndarray>(handle<>(pykball)));
    }
    ...
    return boost::python::make_tuple(static_cast<bpndarray>(handle<>(pyidx)), static_cast<bpndarray>(handle<>(pydists)),static_cast<bpndarray>(handle<>(pykball)));
}
